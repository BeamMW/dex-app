        ...
        <div className="assets-selector-wrapper">
          <div className="asset-selector">
            ...
            <div className="select-wrapper">
              <Select classNamePrefix="custom-select" options={options} onChange={onChangeToken1} />
            </div>
          </div>
          <div className="asset-selector">
            {/* <Input /> */}
            <div className="select-wrapper">
              <Select classNamePrefix="custom-select" options={options2pair} onChange={onChangeToken2} />
            </div>
          </div>
        </div>
